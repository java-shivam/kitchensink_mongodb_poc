...
//import com.kitchensink.demo.bean.NewMember;
...
//    @Named
    ...
    // Getter for newMember to be used in views (e.g., Thymeleaf or JSF)
    public Member getNewMember() {
        return newMember;
    }

    // Setter for newMember (optional, depending on your use case)
